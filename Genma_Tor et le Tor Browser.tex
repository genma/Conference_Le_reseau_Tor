...
\item Il y a une première clé de chiffrement pour le nœud d'entrée, une second clé pour le nœud du milieu et
une dernière pour le nœud de sortie.
\item La résolution DNS est faite par le noeud de sortie.
}
\end{itemize}
\justifying{
$\Rightarrow$ Attention : Tor ne chiffre pas après le noeud de sortie.
\\
...
%----------------------------------------------------------------------------------------
\begin{frame}
\frametitle{Tor hidden service - les services cachés de TOR 1/3}
\justifying{
...
%----------------------------------------------------------------------------------------
\begin{frame}
\frametitle{Tor hidden service - les services cachés de TOR 2/3}
...
%----------------------------------------------------------------------------------------
\begin{frame}
\frametitle{Tor hidden service - les services cachés de TOR 3/3}

\begin{block}{Tutoriaux pour mettre en place un .oinion}
\begin{itemize}
 \justifying{
\item Configuring Hidden Services for Tor
\\ \url{https://www.torproject.org/docs/tor-hidden-service.html.en}
\item Tor, les .onion, le "darknet" à votre portée par Benjamin Sonntag
\\ \url{https://benjamin.sonntag.fr/Tor-les-onion-le-darknet-a-votre-portee}
\item Mon blog dans les oignons par Stéphane Bortzmeyer
...
\begin{itemize}
\justifying{
\item Pas de flash. Mais les vidéos HTML5 passe.
\item Il faut activer le javascript (avec parcimonie).
\item Beaucoup de noeuds de sorties sont bloqués (Cloudfare) etc.
\item Nécessité de saisir des captchas pour ne pas être assimilé à un bot (et d'activer le javascript).
\item On ne peut pas créer de compte (Gmail, Twitter...)
\item On sait qu'on utilise TOR (ou pas, obfuscation).
}
\end{itemize}
\end{frame}
...
%---------------------------------------------------------------------------------------
\begin{frame}
\frametitle{Soutenir le projet Tor 1/4}
...
%---------------------------------------------------------------------------------------
\begin{frame}
\frametitle{Soutenir le projet Tor 2/4}
...
%---------------------------------------------------------------------------------------
\begin{frame}
\frametitle{Soutenir le projet Tor 3/4}
\begin{center}
...
%----------------------------------------------------------------------------------------
\begin{frame}
\frametitle{Soutenir le projet Tor 4/4}
\justifying{
